...
| [`outputs/verification/holdout_run_history.json`](../outputs/verification/holdout_run_history.json) | Sổ ba lần mở holdout dựng từ git history: AUC/F1, top-50, sweep, pairwise deltas, xác minh teammate và khối tham chiếu bàn giao. |
