...
| [`train_run1_report.json`](../outputs/holdout/stage2/train_run1_report.json) | 2 | Cấu hình, phiên bản, hash và kiểm biên của lượt train 1 | artifact | 1,863 B |
| [`train_run2_report.json`](../outputs/holdout/stage2/train_run2_report.json) | 2 | Cấu hình, phiên bản, hash và kiểm biên của lượt train 2 | artifact | 1,863 B |
