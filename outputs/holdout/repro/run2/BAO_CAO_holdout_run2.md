...
| [`catboost_final_holdout_run1.cbm`](../../stage2/catboost_final_holdout_run1.cbm) | 2 | Model CatBoost cuối dùng để chấm holdout | artifact | 1,129,416 B |
| [`catboost_final_holdout_run2.cbm`](../../stage2/catboost_final_holdout_run2.cbm) | 2 | Model train độc lập lần hai để kiểm lặp | artifact | 1,129,416 B |
...
| [`train_run1_report.json`](../../stage2/train_run1_report.json) | 2 | Cấu hình, phiên bản, hash và kiểm biên của lượt train 1 | artifact | 2,011 B |
| [`train_run2_report.json`](../../stage2/train_run2_report.json) | 2 | Cấu hình, phiên bản, hash và kiểm biên của lượt train 2 | artifact | 2,011 B |
...
| [`equity-curve-chunk2-5-top50.png`](../../stage4/equity-curve-chunk2-5-top50.png) | 4 | Ảnh PNG biểu đồ bậc thang baseline và 4 nhánh trên khúc 2–5 | artifact | 93,985 B |
...
| [`outputs/thread_count_sensitivity/thread_count_sensitivity.json`](../../../thread_count_sensitivity/thread_count_sensitivity.json) | Thí nghiệm `thread_count`: bốn cấu hình, deltas prediction, top-50 và `conclusion_facts` lưu tại Phụ lục A. |
